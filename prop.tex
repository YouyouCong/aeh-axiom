...
\begin{lemma}[Compositionality of CPS]
  \label{lem:cpscomp}
...
\begin{proof}
  ...
  \begin{case}[$F = \hole$]
    \begin{align*}
      &\eqspace \cpsc{e} \\
      &= \abstwo{k}{h}{\apptwo{\cpsc{e}}{k}{h}} 
      & \text{by \rulename{$\eta_R$}} \\
      &= \abstwo{k}{h}{\apptwo{\cpsc{e}}{\appp{\cpsf{\hole}}{k}}{h}}
    \end{align*}
  \end{case}

  \begin{case}[$F = \letconp{x}{F}{e_2}$]
    \begin{align*}
      &\eqspace \cpsc{\letconp{x}{F}{e_2}[e]} \\
      &= \cpsf{F[\letin{x}{e}{e_2}]} \\
      &= \abstwo{k}{h}
                {\apptwo{\cpsc{\letinp{x}{e}{e_2}}}
                        {\appp{\cpsf{F}}{k}}
                        {h}} \\
      &= \abstwo{k}{h}
                {\apptwo{\abstwop{k}{h}
      ...
      &= \abstwo{k}{h}
                {\apptwo{\cpsc{e}}
                        {\abstwop{x}{h}{\apptwo{\cpsc{e_2}}{\appp{\cpsf{F}}{k}}{h}}}
                        {h}} \\
      &= \abstwo{k}{h}{\apptwo{\cpsc{e}}{\appp{\cpsf{\letconp{x}{F}{e_2}}}{k}}{h}}
    \end{align*}
  \end{case}
\end{proof}
...
\begin{align*}
  ...
  &= \substtwo{\cpsc{\eop}}
              {x}{\cpsv{v}}
              {r}{\abs{y}
                      {\apptwo{\abstwop{k}{h}{\apptwo{k}{y}{h}}}
                              {\appp{\cpsf{F}}{\abstwop{x}{h}{\cpsc{\eret}}}}
                              {\abstwop{x}{r}{\cpsc{\eop}}}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \substtwo{\cpsc{\eop}}
              ...
              {r}{\abs{y}
                      {\apptwo{\abstwop{k}{h}
                              ...
                              {\abstwop{x}{r}{\cpsc{\eop}}}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \cpsc{\substtwop{\eop}{x}{v}{r}{\abs{y}{\handle{F[\ret{y}}{h}]}}}
  & \text{by Lemma~\ref{lem:cpssubst}}
\end{align*}
\end{case}
...
\begin{align*}
  ...
  &= \apptwo{\abstwop{k}{h}
                     {\apptwo{\abstwop{k}{h}{\apphandp{h}{\cpsv{v_1}}{k}}}
                             ...
                             {h}}}
            {\abstwop{x}{h}{\cpsc{\eret}}}
            {\abstwop{x}{r}{\app{r}{\cpsv{v_2}}}}
  & \text{by Lemma~\ref{lem:cpscomp}} \\
  &= \apptwo{\abstwop{k}{h}{\apphandp{h}{\cpsv{v_1}}{\appp{\cpsf{F}}{k}}}}
            {\abstwop{x}{h}{\cpsc{\eret}}}
            {\abstwop{x}{r}{\app{r}{\cpsv{v_2}}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \apphand{\abstwop{x}{r}{\app{r}{\cpsv{v_2}}}}
             {\cpsv{v_1}}
             {\appp{\cpsf{F}}{\abstwop{x}{h}{\cpsc{\eret}}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \app{\absp{y}
  ...
  &= \apptwo{\abstwop{k}{h}{\apptwo{k}{\cpsv{v_2}}{h}}}
            {\appp{\cpsc{F}}{\abstwop{x}{h}{\cpsc{\eret}}}}
            {\abstwop{x}{r}{\app{r}{\cpsv{v_2}}}}
  ...
  &= \apptwo{\abstwop{k}{h}
            ...
            {\abstwop{x}{r}{\app{r}{\cpsv{v_2}}}}
  & \text{by \rulename{$\beta.R$}} \\
  &= \cpsc{\handlep{F[\ret{v_2}]}{\opclsone{x}{r}{\app{r}{v_2}}}}
  % &= \abstwo{k}{h}
  %           {\apptwo{\appp{\cpsf{F}}
...
\begin{case}[$h_{letv}$]
\begin{align*}
  &\eqspace \cpsc{\handlep{\letin{x}{\ret{v}}{e}}{\hdef}} \\
  &= \apptwo{\abstwop{k}{h}
                     {\apptwo{\abstwop{k}{h}{\apptwo{k}{\cpsv{v}}{h}}}
                             {\abstwop{x}{h}{\apptwo{\cpsc{e}}{k}{h}}}
                             {h}}}
            {\abstwop{x}{h}{\cpsc{\eret}}}
            {\abstwop{x}{r}{\cpsc{\eop}}} \\
  &= \apptwo{\abstwop{x}{h}{\apptwo{\cpsc{e}}{\abstwop{x}{h}{\cpsc{\eret}}}{h}}}
            {\cpsv{v}}
            {\abstwop{x}{r}{\cpsc{\eop}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \apptwo{\subst{\cpsc{e}}{x}{\cpsv{v}}}
            {\abstwop{x}{h}{\cpsc{\eret}}}
            {\abstwop{x}{r}{\cpsc{\eop}}}
  & \text{by \rulename{$\beta_{let}$}} \\
  &= \abstwo{k}{h}
            {\apptwo{\apptwop{\subst{\cpsc{e}}{x}{\cpsv{v}}}
                             {\abstwop{x}{h}{\cpsc{\eret}}}
                             {\abstwop{x}{r}{\cpsc{\eop}}}}
                     {k}
                     {h}}
  ...
  &= \abstwo{k}{h}
            {\apptwo{\abstwop{k}{h}{\apptwo{k}{\cpsv{v}}{h}}}
                    ...
                    {h}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \cpsc{\letinp{x}{\ret{v}}{\handle{e}{\hdef}}}
\end{align*}
\end{case}

\begin{case}[$h_F$]
\begin{align*}
  &\eqspace \cpsc{\handlep{F[e]}{\hdef}} \\
  &= \apptwo{\abstwop{k}{h}
                     {\apptwo{\cpsc{e}}{\appp{\cpsf{F}}{k}}{h}}}
            {\abstwop{x}{h}{\cpsc{\eret}}}
            {\abstwop{x}{r}{\cpsc{\eop}}} \\
  &= \apptwo{\cpsc{e}}
            {\appp{\cpsf{F}}{\abstwop{x}{h}{\cpsc{\eret}}}}
  ...
  &= \apptwo{\cpsc{e}}
            {\abstwop{x}{h}
                     {\apptwo{\appp{\cpsf{F}}{\abstwop{x}{h}{\eret}}}
                             {x}
                             {\abstwop{x}{r}{\eop}}}}
            {\abstwop{x}{r}{\cpsc{\eop}}}
  & \text{by ???} \\
  &= \apptwo{\cpsc{e}}
            {\abstwop{x}{h}
                     {\apptwo{\abstwop{k}{h}
                                      {\apptwo{\abstwop{k}{h}{\apptwo{k}{x}{h}}}
                                              {\appp{\cpsf{F}}{k}}
                                              {h}}}
                             {\abstwop{x}{h}{\eret}}
                             {\abstwop{x}{r}{\eop}}}}
            {\abstwop{x}{r}{\cpsc{\eop}}}
  & \text{by \rulename{$\beta_R$}} \\
  &= \cpsc{\handlep{e}{\retcls{x}{\handle{F[\ret{x}]}{\hdef}}}}
\end{align*}
\end{case}
